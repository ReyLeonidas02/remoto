					...
					<div class="container">
						<div id="content">
							...
							<!-- Content -->
								...
								<form action="operaciones.jsp?pagina=bajajugador" method="post">
									<div class="row gtr-50">
										<div class="">
										<label for="codJugador">Jugador</label>
											<input type="number" name="codJugador" id="codJugador" placeholder="Id Jugador" style="width:450px"; maxlength="20"/>
										</div>
