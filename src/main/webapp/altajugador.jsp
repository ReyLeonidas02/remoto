					...
					<div class="container">
						<div id="content">
							...
							<!-- Content -->
								...
								<h3>Alta Jugador</h3>
								<form action="operaciones.jsp?pagina=altajugador" method="post">
									<div class="row gtr-50">
										<div class="">
										<label for="nombre">Nombre</label>
											<input type="text" name="nombre" id="nombre" placeholder="nombre" style="width:450px"; maxlength="20"/>
										</div>
										<div class="">
										<label for="nombre">Pierna</label>
											<input type="text" name="pierna" id="pierna" placeholder="pierna" maxlength="9"/>
										</div>
										<div class="">
										<label for="nombre">Altura</label>
											<input type="number" name="altura" id="altura" placeholder="altura" maxlength="3"/>
										</div>
										<div class="">
										<label for="nombre">Pais</label>
											<input type="text" name="pais" id="pais" placeholder="pais" maxlength="20"/>
										</div>
										<div class="">
										<% BDController control = new BDController(); %>
										
										<label for="equipo">Elige equipo</label>
											<select name="equipo" id="equipo" width="200px" height="80px">
