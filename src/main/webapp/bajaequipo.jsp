					...
					<div class="container">
						<div id="content">
							...
							<!-- Content -->
								...
								<form action="operaciones.jsp?pagina=bajaequipo" method="post">
									<div class="row gtr-50">
										<div class="">
										<label for="bajaEquipo">Equipo</label>
											<input type="number" name="bajaEquipo" id="bajaEquipo" placeholder="Id del equipo" style="width:450px"; maxlength="20"/>
										</div>
