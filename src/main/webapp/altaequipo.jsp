					...
					<div class="container">
						<div id="content">
							...
							<!-- Content -->
								...
								<h3>Alta Equipo</h3>
								<form action="operaciones.jsp?pagina=altaequipo" method="post">
									<div class="row gtr-50">
										<div class="">
										<label for="nombre_equipo">Nombre</label>
											<input type="text" name="nombre_equipo" id="nombre_equipo" placeholder="nombre" style="width:450px"; maxlength="20"/>
										</div>
										<div class="">
										<% BDController control = new BDController(); %>
										<label for="codigo_liga_equipo">Elige la liga</label>
										<select name="codigo_liga_equipo" id="codigo_liga_equipo" style="margin: 2rem">
										<% for(Liga l: control.listadoLigas()){ %>	
											<option value="<%=l.getCod_liga() %>"><%=l.getNombre() %></option>
										</div>
										<%}; %>
									</div>
