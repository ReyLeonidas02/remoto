					...
					<div class="container">
						<div id="content">
							...
							<!-- Content -->
								...
								<h3>Alta Jugador</h3>
								<form action="operaciones.jsp?pagina=altaliga" method="post">
									<div class="row gtr-50">
										<div class="">
										<label for="nombre_liga_alta">Nombre Liga</label>
											<input type="text" name="nombre_liga_alta" id="nombre_liga_alta" placeholder="nombre" style="width:450px"; maxlength="20"/>
										</div>
										<div class="">
										<label for="pais_liga">Pais de la liga</label>
											<input type="text" name="pais_liga" id="pais_liga" placeholder="pais" maxlength="20"/>
										</div>
